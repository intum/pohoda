    ...
    module Enq
      class EnquirySummaryType
        ...
        def type_calculate_vat_inclusive_price
          at 'enq:typeCalculateVATInclusivePrice'
        end

        def type_calculate_vat_inclusive_price_attributes
          attributes_at 'enq:typeCalculateVATInclusivePrice'
        end
        ...
        def to_h
          ...
          hash[:type_calculate_vat_inclusive_price] = type_calculate_vat_inclusive_price if has? 'enq:typeCalculateVATInclusivePrice'
          hash[:type_calculate_vat_inclusive_price_attributes] = type_calculate_vat_inclusive_price_attributes if has? 'enq:typeCalculateVATInclusivePrice'
